          ...
          <div className="flex items-center space-x-2">
            {product.rating && (
              <>
                ...
                <span className="text-muted-foreground text-sm">({product.rating.toFixed(1)} - {Math.floor(Math.random()*50 + 5)} reviews)</span> 
...
// Generate static paths for better SEO and performance (optional, can be dynamic)
